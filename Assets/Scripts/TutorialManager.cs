...
public class TutorialManager : MonoBehaviour
{
    ...
    {
        "-HOW DARE YOU TOUCH MY TREASURE,MORTAL!",
    ...
    {
        chestAnimator.SetTrigger(TreasureCurseConst.AnimatorChestCloseEndText);
    ...
    private IEnumerator LastTextTime(float a)
    {
        yield return new WaitForSeconds(a);
        LastText();
    }
    private void MageText(int a)
    {
        textbox.gameObject.SetActive(true);
